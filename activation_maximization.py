...
layer_names = ["activation_10", "activation_22", "activation_34", "activation_46"]
count = 1
for layer_name in layer_names:
    ...
    for i in filters:
        ...
        a.save('act_max_output/' + layer_name + '_finetuned_' + str(i) + '.png') # change this when pre-trained model is used
